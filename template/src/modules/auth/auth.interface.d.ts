import z from 'zod';
import { ChangePasswordZodSchema, ForgotPasswordZodSchema, LoginUserZodSchema, RegisterUserZodSchema, ResetPasswordZodSchema, VerifyEmailZodSchema } from './auth.validation';
